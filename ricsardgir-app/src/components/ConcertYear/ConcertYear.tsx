  ...
  return (
    <div className="p-4 max-w-7xl	m-auto">
      <div className="grid grid-cols-[repeat(auto-fit,_minmax(240px,_1fr))] auto-rows-[160px] grid-flow-row-dense gap-x-8 gap-y-8">
        <div className="h-16 font-black text-gir-500 text-9xl row-span-1 col-span-4 flex justify-center" id={`year${props.year}`}/>
        <div className="h-16 font-black text-gir-500 text-9xl row-span-1 col-span-4 flex justify-center">{props.year}</div>
