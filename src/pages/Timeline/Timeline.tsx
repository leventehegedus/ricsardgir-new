...
const movieStoryBlock = [
  { year: 2001, text: 'Mártondani megírja a Repülőgép című dalt egy két húros akusztikus gitáron.' },
  ...
  { year: '', text: 'Első pesti koncertünkön Laci előző zenekarával, az 1160-nal fellépünk a Filterben.' },
  { img: '/concerts/20.jpg' },
  ...
  { year: '', text: 'Elindult az Instagram oldaunk.' },
  { year: '', text: 'Konsiczky Dávid a Ricsárdgír zenekar tagja lesz fél éven keresztül.' },
  { year: '', text: 'Megújul a TheRicsardGirls, Budapesten Dj-znek, Kovács Fruzsi, Deák Edina és Szőke Zsófi. Ők lesznek a TheRicsardGirls Bad Dj Party.' },
  ...
  { img: '/concerts/123.jpg' },
  { year: '', text: 'Több ezer ember előtt koncerteztünk a Kossuth téren és a CEU mellett foglaltunk állást. A MAgyar Narancs Mártondani átkötő szövegére azt írta a tüntetés legjobb mondata.' },
  ...
  { year: '', text: 'A német Arte Tv velünk forgatott egy műsort.' },
  { year: '', text: 'Május 22-én hajnali 3-kor fánkokkal és kávéval bekészítve várjuk a Twin Peaks harmadik évadának premierjét.' },
  { img: '/concerts/148.jpg' },
  { year: '', text: 'Az OTP hírdetett egy közönségszavazást, hogy melyik koncert volt a legjobb a Kolorádó Fesztiválon, a Ricsárdgír nyerte ezt a díjat. Kaptunk több százezer forintnyi hangszervásárlásos utalványt, de mindet elhagytuk még aznap a Gólyában. Másnap visszamentünk és pár ilyen utalványt megtaláltunk a szőnyeg alatt.' },
  ...
  { year: '', text: 'A Bánkitó Fesztiválon megismerkedünk Tóth Dórival, aki egy közért előtt a betonon guggol és a Halál;orgazmus koncerten hegedül. Mártondani megkérdezi, ha ad neki belépőt, nem megy -e fellépni velük egy óra múlva.' },
  ...
  { year: '', text: 'Az Életem legrosszabb napja című mozifilmben is több ricsárdgír dal szerepelt.' },
  { year: '', text: 'Meghívtak minket a LakásTalkShowba ahol Lovász Péter és Steinker Kristóf beszélgetett, a Sztár vagy szart adtuk elő, de nem mondhattuk a tévében hogy szar, ezért úgy énekeltük, hogy sztár vagy sztar.' },
  ...
  { img: '/concerts/176.jpg' },
  { year: '', text: 'Több szíbházi darabban is szerepel a zenénk.' },
  { year: '', text: 'Europavoxon a Band of the Day lettünk.' },
  { year: '', text: 'Mártondani megrendezi a Rossz színészt, amit 2020-ban az évtized legjobb magyar kisfilmjének választanak, a Ricsárdgír szerepel benne egy bulijeneletben, Lacinak pedig szöveges szerep jut.' },
  { year: '', text: 'Tóth Dóri véglegesen beszáll a Ricsárdgírbe.' },
  { year: '', text: 'A Bohemian Betyarsszal turnézni indultunk.' },
  ...
  { year: '', text: 'Sebestyén Balázsék a Ricsárdgírről beszéltek viszonylag sokáig a Morning Showban a Vadjon Janival és a Rákóczi Ferivel.' },
  ...
  { year: '', text: 'Az Engedetlen című mozifilmben több Ricsárdgír dal is elhangzott.' },
  ...
  { year: '', text: 'Az Első ArtFart fesztet megtartjuk Szentendrén.' },
  { year: '', text: 'Első önálló turnén is van.' },
  { year: '', text: 'Heatlie Dávid és Kun Bálint lesz a dobosunk.' },
  { img: '/concerts/193.jpg' },
  { year: '', text: 'Tóth Virág divatbemutatóján zenéltünk és modellkedtünk' },
  { year: '', text: 'Huszár Ákos lesz a Ricsárdgír zenekar dobosa.' },
  { year: '', text: 'Ebben az évben is szerepeltünk az RTL KLUB híradóban, mert a Volton kétszer is előadtuk a Mindenki boldogot két ORbán beszéd között.' },
  ...
  { year: '', text: 'Mi írjuk meg a 2020-as Fishing on Orfű himnuszát.' },
  { year: '', text: 'A Gála sör Ricsárdgír söröket kezd gyártani.' },
  { img: '/concerts/194.jpg' },
  ...
  { year: '', text: 'Városnéző túrát tartottunk a közönségünkkel Szentendrén.' },
  ...
  { year: '', text: 'A Való Világ 10-ben Ricsárdgírre táncoltak a versenyzők.' },
  { year: '', text: 'Első teltházas Akváriumos nagyhallos koncertünk, ahol nincs előzenekar, csak mi.' },
  { img: '/concerts/245.jpg' },
  { year: '', text: 'Lett végre saját próbatermünk.' },
  ...
  { year: '', text: 'Egy másik színházi darabban is szerepel a zenekar, a Szabad világ című dallal.' },
  { year: '', text: 'A nemzetközi Ricsárdgír napra hatalmas pikniket szervezünk.' },
  { year: '', text: 'SzintisLaci találkozik Ördög Nórával és Nánási Pállal és szelfiznek' },
  { year: '', text: 'Mártondani menedzseri és marketing órákat kezd tartani országszerte, ahova hívják. Van ahol zenesuliban tart előadást, van ahol felnőtteknek. Itt hangzik el először, hogy egy feloszlás akkor jó, ha értelmetlen.' },
  ...
  { year: '', text: 'A The Fantastic Adventures of Laci című számítógépes játékot fejleszteni kezdi a GírGames.' },
  ...
  { year: 2022, text: '2022 június 9-én megjelenik a Hülye vagy című dalunk, amit nem klipnek szánunk, de klipnek hiszik az emberek. Ez a Zanox című film betétdala. Ezt a dalt jelölik a klipszemlén legjobb ötlet kategóriában, de mivel nincs benne ötletr, nem nyer. Mártondani viszont behúz egy díjat a Carson Coma klippel amit rendezett.' },
  { year: '', text: 'A Petőfi elkezdi játszani a Hülye vagyot és a Smacklevest.' },
  { year: '', text: 'Elkészül egy olyan lemez, amin csak Bródí dalokat dolgoznak fel küölönbüöző zenekarok. Mi is köztük vagyunk.' },
  { year: '', text: 'Az Éndalom című dallal egy harmadik színházi darabban is szerepel a zenekar.' },
  ...
  { year: '', text: 'A Partizán külön portré filmet forgat velünk a Monoszkópba.' },
  { img: '/concerts/268.jpg' },
  ...
  { year: '', text: 'Elrepülünk Svájcba fellépni és megünnepelni hogy szavaztunk, aztán persze mindenki iszonyatosan depresszós lett a végeredményt látva, de Svájc jó volt.' },
  ...
  { year: '', text: 'Megalakul a Koala Allstars Band, amiben a Bohemian Betyars van, Szabó Benedek, Henzli Fanni, Dé:nash és Kollár-Klemencz Laci.' },
  { year: '', text: 'Újra alakul a TheRicsardGirls Tóth Dórival, Borszukovszky Flórával, Deák Edinával, Papp Évával és Kovács Zsókával' },
  { year: '', text: 'A Recorder magazin címlapján vagyunk.' },
  { img: '/concerts/307.jpg' },
  { year: '', text: 'Május 18 - a Ricsárdgír zenekar feloszlik...' },
]
...
export const Timeline: React.FC = () => {
  ...
  const renderStoryBlock = (block: {
    ...
    return (
      ...
      >
        <span className="font-black uppercase text-gir-500 text-6xl">{block.year}</span>
