...
const apiKey = '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';
  ...
  return (
    <div>
      <div className="w-full mb-4">
        <input className="text-black w-full" type="text" value={message} onChange={handleInputChange} />
      </div>
      <button className="text-white border border-solid border-white p-4" onClick={handleButtonClick}>Send</button>
      {isLoading ?
        'A koala most épp gondolkodik a válaszon' : (
          answer &&
          <div className="text-white">
            {answer}
          </div>
